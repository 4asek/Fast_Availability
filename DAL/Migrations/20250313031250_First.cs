        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProceedTime = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrackLogs", x => x.TrackId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrackId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TrackLogTrackId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Shipments_TrackLogs_TrackLogTrackId",
                        column: x => x.TrackLogTrackId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipments_TrackLogTrackId",
                table: "Shipments",
                column: "TrackLogTrackId");
        }
